...
export default function Home() {
  return (
    <div className="bg-[#000000] min-h-screen flex flex-col overflow-hidden text-white">
      ...
      <main className="flex-grow">
        ...
        <div data-aos="fade-up" className="max-w-7xl mx-auto px-4 my-12">
  <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-[#141414] to-[#0a0a0a] border border-gray-800/80 p-8 md:p-16 shadow-2xl">
    ...
    {/* Efeito Glow / Luz de fundo no canto superior */}
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
      ...
      <div className="lg:col-span-7 flex flex-col items-start text-left">
        ...
        <a
          href="https://wa.me/5511999999999" // Altere para o link do WhatsApp ou formulário
          target="_blank"
      ...
      {/* Coluna da Direita: Card Interativo / Painel Demonstrativo */}
