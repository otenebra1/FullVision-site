            ...
            {isAdmin && (
              <div className="bg-gradient-to-r from-purple-950/50 via-gray-900 to-gray-900 border border-purple-500/30 rounded-2xl p-6 shadow-2xl space-y-4">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  <a href="https://drive.google.com/drive/u/1/folders/1jra6a5Te3NBLsyrpNCds0JGk-t01Rs7a" className="bg-gray-950/80 hover:bg-gray-800 border border-gray-800 hover:border-purple-500/50 rounded-xl p-3 flex items-center gap-3 transition-all"><FaGoogleDrive className="text-emerald-400 text-lg" /> <span className="text-sm font-semibold">Drive</span></a>
                  ...
                  <a href="https://www.admin.fullvision.one" className="bg-gray-950/80 hover:bg-gray-800 border border-gray-800 hover:border-purple-500/50 rounded-xl p-3 flex items-center gap-3 transition-all"><FaUserTie className="text-amber-400 text-lg" /> <span className="text-sm font-semibold">Admin</span></a>
                  <a href="https://www.appsheet.com/start/0033dbd6-2755-404f-8612-c1353a4ccb6b?platform=desktop#appName=Full-ERP-359222463&vss=H4sIAAAAAAAAA62PTQrCMBCFryKzDh4gWxUUURcVN00XsZlAMG1Kkqol5FQewYuZ-IO4LS7nzXxv3gtwVngpPK9PQMvwndY4AIXAYD90yIAymJnWW6MZEAZb3rzEpXL-frOqNpPdtGAQIVbk4-LRAQ1jTOg_khBQAluvpEKbHTOfnN50Wmc2Cb8kRAJN7_lR47NCJqXSHu0cJe-1T53KKsZ0Jk3dOxSHlHR0QrdqF9eOt2JjRPoluXYYH-L1uVyWAQAA&view=Histórico%20O.S" className="bg-gray-950/80 hover:bg-gray-800 border border-gray-800 hover:border-purple-500/50 rounded-xl p-3 flex items-center gap-3 transition-all"><FaDatabase className="text-indigo-400 text-lg" /> <span className="text-sm font-semibold">ERP</span></a>
                </div>
              </div>
            )}
