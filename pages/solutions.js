  ...
  const technologyCatalog = [
    {
      ...
      title: "Tecnologia Satelital Pura",
      tech: "Comunicação via satélite bidirecional, ideal para rotas de alta criticidade e áreas de sombra sem sinal de telefonia celular. Cobertura 100% global."
    },
    {
    ...
    },
    {
      ...
      title: "Telemetria Avançada CanBus",
      tech: "Leitura direta do computador de bordo do veículo. Monitora rotação do motor, frenagem brusca, temperatura do óleo e identifica o comportamento do motorista."
    }
  ];
            ...
            {activeTab === 'catalog' && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 animate-fade-in">
                {technologyCatalog.map((tech, idx) => (
                  <div key={idx} className="bg-[#0f0f0f] border border-white/10 rounded-xl p-6 flex flex-col justify-between hover:scale-[1.02] transition-transform duration-300">
                    <div>
                      ...
                      <p className="text-gray-400 text-xs leading-relaxed">{tech.tech}</p>
                    </div>
                    <div className="mt-6 text-xs text-blue-500 font-semibold uppercase tracking-wider">
