  ...
  return (
    ...
    <div className="bg-[#000000] min-h-screen flex flex-col overflow-hidden">
      <Head>
        ...
        <meta property="og:title" content="FullVision Tracking" />
        <meta property="og:description" content="Gestão de operação logística e segurança da frota com tecnologia de ponta." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://fullvision.one" />
